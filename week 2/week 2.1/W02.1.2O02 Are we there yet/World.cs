static class World
{
    ...
    private static void PopulateLocations()
    {
        ...
        Location loc1Start = new(LOCATION_ID_LOC1, "Start");
        Location loc2      = new(LOCATION_ID_LOC2, "Empty location");
        Location loc3      = new(LOCATION_ID_LOC3, "Empty location");
        Location loc4      = new(LOCATION_ID_LOC4, "Empty location");
        Location loc5      = new(LOCATION_ID_LOC5, "Empty location");
        Location loc6Goal  = new(LOCATION_ID_LOC6, "Goal");
